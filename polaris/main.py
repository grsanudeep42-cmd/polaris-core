...
from polaris.core.logging_config import setup_logging
from polaris.core.middleware import RequestIDMiddleware
from polaris.core.exceptions import ApiException
from polaris.db.session import engine
from polaris.api.v1.api import api_router
from polaris.core.events.registry import event_bus
from polaris.modules.test.handlers import TestCreatedHandler
from polaris.modules.test.events import TestCreatedEvent
from polaris.core.events.registry import event_bus
from polaris.core.events.audit_event import AuditEvent
from polaris.core.events.audit_handler import AuditEventHandler
# ------------------------------------------------------------------
